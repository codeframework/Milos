...
namespace Milos.Business.Names
{
    ...
    {
        #region Lists (Corp IDs, Suffixes, Titles...)

        /// <summary>
        /// Exposes list of CorpIDs (read-only). 
        /// </summary>
        public ArrayList CorpIDs { get; } = new ArrayList();

        /// <summary>
        /// Exposes list of Suffixes (read-only).
        /// </summary>
        public ArrayList Suffixes { get; } = new ArrayList();

        /// <summary>
        /// Exposes list of Titles (read-only).
        /// </summary>
        public ArrayList Titles { get; } = new ArrayList();
