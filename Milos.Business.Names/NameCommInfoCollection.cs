...
public class NameCommInfoCollection(IBusinessEntity parentEntity) : EntityXlinkSubItemCollection(parentEntity)
{
...
public class NameCommInfoEntity(IEntitySubItemCollection parentCollection) : EntitySubItemCollectionXLinkItem(parentCollection), INameCommInfoEntity
{
    /// <summary>
    /// Comm info type (email, phone,...)
    /// </summary>
