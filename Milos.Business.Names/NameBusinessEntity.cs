...
namespace Milos.Business.Names
{
    ...
    public class NameBusinessEntity : BusinessEntity, INameEntity
    {
        ...
        {
            // We generate a comminfo collection
            var bizName = (NameBusinessObject) AssociatedBusinessObject;
        ...
        /// <summary>
        /// This method loads the name/catergory collection
        /// This method can be overridden in subclasses.
        /// </summary>
    ...
    public class NameEntity : NameBusinessEntity
    {
        ...
        public new static NameEntity LoadEntity(Guid id) => new NameEntity(id);
        public new static NameEntity NewEntity() => new NameEntity();
    }
}