...
namespace Milos.Business.Names
{
    ...
    /// </summary>
    public class FlatAddressEnumerator : IEnumerator
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="collection">Enumerated collection</param>
        public FlatAddressEnumerator(NameAddressFlatCollection collection) => parentCollection = collection;

        /// <summary>
        /// For internal use only
        /// </summary>
        private readonly NameAddressFlatCollection parentCollection;
    ...
    /// </summary>
    public class NameAddressFlatEntity : INameAddressEntity
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public NameAddressFlatEntity(NameAddressFlatCollection collection, DataRow row)
        {
