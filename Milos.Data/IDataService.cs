...
public interface IDataService : IDisposable
{
    ...
    /// <remarks>Prefer GetAllRecordsAsync(string, string, string, DataRowProcessMethod) for new code.</remarks>
    ...
    /// The name of the method is a little misleading. It can actually return more than one query *if* the key
    /// field used for the query is non-unique (in other words: not a primary key field).
    /// Prefer GetSingleRecordAsync(string, string, string, object, DataRowProcessMethod) for new code.
    /// </remarks>
    /// <param name="tableName">Name of the table to query.</param>
    /// <param name="fieldList">List of fields to return.</param>
    /// <param name="primaryKeyFieldName">Name of the primary key field.</param>
    ...
    /// <param name="selectMethod">Process method for the select method</param>
    /// <returns>DataSet with the returned data</returns>
    /// <remarks>Prefer QueryAsync(string, string, IList{string}, IList{object}, DataRowProcessMethod) for new code.</remarks>
    /// <example>
    /// var fieldNames = new string[] { "FirstName", "LastName", "IsActive" };
    /// var parameters = new object[] { "Chris", "Pronger", true };
    ...
    /// <returns>DataSet with the returned data</returns>
    /// <remarks>Prefer QueryAsync(IDbCommand, string) for new code.</remarks>
    /// <example>
    ...
    /// <param name="entityName">Name of the table in the resulting DataSet</param>
    /// <returns>DataSet with the returned data</returns>
    /// <remarks>Prefer QueryAsync(string, Dictionary{string, object}, string) for new code.</remarks>
    /// <example>
    ...
    /// <remarks>Since this returns all data, from a table, this method should only be used for small tables. Prefer GetListAsync(string, string, string, DataRowProcessMethod) for new code.</remarks>
    /// <example>
