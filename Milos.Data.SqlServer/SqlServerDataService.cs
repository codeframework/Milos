...
namespace Milos.Data.SqlServer
{
    ...
    public class SqlDataService : DataService
    {
        ...
        /// </summary>
        private readonly List<AppRoleStackItem> appRoleStack = new List<AppRoleStackItem>();
                    ...
                    if (string.IsNullOrEmpty(configMethod))
                        ...
                        switch (configMethod)
                        {
                            case "storedprocedures":
                                allowedDataAccessMethod = AllowedDataAccessMethod.StoredProceduresOnly;
                                break;
                            case "individualcommands":
                                allowedDataAccessMethod = AllowedDataAccessMethod.IndividualCommandsOnly;
                                break;
                            default:
                                allowedDataAccessMethod = AllowedDataAccessMethod.All;
                                break;
        ...
        public override IDbCommand BuildUpdateCommand(DataRow changedRow, KeyType primaryKeyType, string primaryKeyFieldName, string tableName, DataRowUpdateMode updateMode = DataRowUpdateMode.ChangedFieldsOnly, DataRowProcessMethod updateMethod = DataRowProcessMethod.Default, IList<string> fieldNames = null, IDictionary<string, string> fieldMaps = null)
        {
            ...
            switch (updateMethod)
            {
                ...
                case DataRowProcessMethod.IndividualCommands:
                    return DataHelper.BuildSqlUpdateCommand(changedRow, primaryKeyType, primaryKeyFieldName, this, updateMode, tableName, fieldNames, fieldMaps);
                case DataRowProcessMethod.StoredProcedures:
                    return DataHelper.BuildStoredProcedureUpdateCommand(changedRow, primaryKeyType, primaryKeyFieldName, this, updateMode, DefaultStoredProcedurePrefix, tableName, fieldNames, fieldMaps);
                default:
                    throw new UnsupportedProcessMethodException("SQL Server databases can not be updated through the chosen update method: " + updateMethod);
            }
        }
        ...
        public override IDbCommand BuildQueryCommand(string tableName, string fieldList, IList<string> fieldNames = null, IList<object> filterParameters = null, DataRowProcessMethod selectMethod = DataRowProcessMethod.Default)
        {
            ...
            if (filterParameters == null) filterParameters = new List<object>();
