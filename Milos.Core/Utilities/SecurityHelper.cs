...
namespace Milos.Core.Utilities
{
    ...
    public static class SecurityHelper
    {
        ...
        public static byte[] EncryptBytes(byte[] inputString, byte[] encryptionKey)
        {
            ...
            return des.CreateEncryptor().TransformFinalBlock(inputString, 0, inputString.Length);
        }
        ...
        public static byte[] DecryptBytes(byte[] decryptBuffer, byte[] encryptionKey)
        {
            ...
            return des.CreateDecryptor().TransformFinalBlock(decryptBuffer, 0, decryptBuffer.Length);
        }
