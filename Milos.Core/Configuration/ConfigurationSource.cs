namespace Milos.Core.Configuration
{
    /// <summary>
    /// This class implements the IConfigurationSource interface and it serves as the base class
    ...
    public abstract class ConfigurationSource : IConfigurationSource
    {
        ...
        /// Constructor
        ///</summary>
        protected ConfigurationSource() => IsActive = true;
        ...
        /// </example>
        public virtual bool IsSettingSupported(string settingName) => Settings.Contains(settingName);
        ...
        /// </example>
        public virtual ConfigurationSourceSettings Settings => settings ?? (settings = new ConfigurationSourceSettings(this));
