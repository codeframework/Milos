...
namespace Milos.BusinessObjects
{
    ...
    public class Dependency : IDeletionDependency
    {
        public Dependency(IDeletionDependency parent, Guid topPrimaryKey)
        {
            CurrentTopPrimaryKeyValue = topPrimaryKey;
            Parent = parent;
        }
        ...
        public IDeletionDependency Parent { get; }
