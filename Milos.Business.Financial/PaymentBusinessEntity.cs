...
public class PaymentBusinessEntity : BusinessEntity
{
    ...
    public CreditCardTypeEnum CreditCardType
    {
        get
        {
            ...
            return creditCardNumber switch
            {
                "3" => CreditCardTypeEnum.AmericanExpress,
                "4" => CreditCardTypeEnum.Visa,
                "5" => CreditCardTypeEnum.MasterCard,
                "6" => CreditCardTypeEnum.DiscoverCard,
                _ => CreditCardTypeEnum.UnknownCard,
            };
        }
    }
